...
export const AppLayout: React.FC = () => {
  const location = useLocation();
  const { userProgress, onNavigatePage, startOrResumeLearningPath, openBookingModal, isSidebarOpen, setIsSidebarOpen, isSidebarCollapsed, toggleSidebarCollapse, handleSelectSimulationById } = useOutletContext<any>();
  const navigate = useNavigate();
