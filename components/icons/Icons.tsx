...
// FIX: Export IconProps type so it can be imported and used in other files.
...
export const WalletIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a2.25 2.25 0 00-2.25-2.25H15a3 3 0 11-6 0H5.25A2.25 2.25 0 003 12m18 0v6a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18v-6m18 0V9M3 12V9m18 3a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 12m15-3V4.5A2.25 2.25 0 0015.75 2.25h-5.5A2.25 2.25 0 008.25 4.5V9" />
    </svg>
);
...
export const FireIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zm0-4.5v4.5c0 .621.504 1.125 1.125 1.125h3.375" />
    </svg>
);
...
export const CpuChipIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5a2.25 2.25 0 00-2.25 2.25v10.5a2.25 2.25 0 002.25 2.25s0 0 0 0h.008v.008h-.008v-.008zm0 0a2.25 2.25 0 012.25 2.25v10.5a2.25 2.25 0 01-2.25 2.25s0 0 0 0h-.008v.008h.008v-.008z" />
    </svg>
);
...
export const PiggyBankIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25v-1.5m0 1.5c-1.355 0-2.697.056-4.024.166C6.845 8.51 6 9.473 6 10.608v2.513m6-4.871c1.355 0 2.697.056 4.024.166C17.155 8.51 18 9.473 18 10.608v2.513M15 8.25v-1.5m-6 1.5v-1.5m12 9.75-1.5.75a3.354 3.354 0 0 1-3 0l-1.5-.75a3.354 3.354 0 0 0-3 0l-1.5.75a3.354 3.354 0 0 1-3 0l-1.5-.75m15 0-3.375-3.375M9 15l-3.375-3.375m1.5-1.5a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
    </svg>
);
...
export const RocketLaunchIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a14.95 14.95 0 00-5.84-2.56m0 0a14.95 14.95 0 01-5.84-2.56m5.84 2.56v-4.82m0 4.82a14.95 14.95 0 005.84 2.56M12 4.5v-2.25m0 19.5v-2.25m0-15a14.95 14.95 0 015.84 2.56m-5.84-2.56a14.95 14.95 0 00-5.84 2.56m11.68 0a1.5 1.5 0 00-2.247-2.247l-2.248 2.247m0 0a1.5 1.5 0 01-2.248-2.247l2.248-2.247m-2.248 2.247a1.5 1.5 0 00-2.248 2.247l2.248 2.247m0 0l2.247 2.247m-2.247-2.247a1.5 1.5 0 012.247 2.247l-2.247 2.247" />
    </svg>
);

export const UserGroupIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.289 2.72a3 3 0 01-4.682-2.72 9.094 9.094 0 013.741-.479m7.289 2.72a8.97 8.97 0 01-7.289 0M12 12.72a3 3 0 00-3-3m3 3a3 3 0 003-3m-3 3v6.72A3 3 0 0015 15.72v-6.72a3 3 0 00-3-3z" />
    </svg>
);

export const FunnelIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3c2.755 0 5.455.232 8.083.678.533.09.917.556.917 1.096v1.044a2.25 2.25 0 01-.659 1.591l-5.432 5.432a2.25 2.25 0 00-.659 1.591v2.927a2.25 2.25 0 01-1.07 1.942l-3.22 1.61A2.25 2.25 0 014.5 19.5v-2.927a2.25 2.25 0 00-.659-1.591L.659 9.82A2.25 2.25 0 010 8.229V7.185c0-.54.384-1.006.917-1.096A48.32 48.32 0 0112 3z" />
    </svg>
);

export const LightBulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-1.125a6.01 6.01 0 001.5-1.125a6.01 6.01 0 00-3-2.25m-3 2.25a6.01 6.01 0 00-1.5 1.125a6.01 6.01 0 00-1.5 1.125M12 18v-5.25m0 0a6.01 6.01 0 01-1.5-1.125a6.01 6.01 0 01-1.5-1.125m1.5 1.125a6.01 6.01 0 01-3 2.25m3-2.25a6.01 6.01 0 013 2.25m0-2.25a6.01 6.01 0 011.5 1.125a6.01 6.01 0 011.5 1.125m-1.5-1.125a6.01 6.01 0 01-3-2.25m3 2.25a6.01 6.01 0 01-3-2.25M6 18c0-3.314 2.686-6 6-6s6 2.686 6 6-2.686 6-6 6-6-2.686-6-6z" />
    </svg>
);
...
export const DiscordIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M20.317,4.369a19.791,19.791,0,0,0-4.885-1.515.074.074,0,0,0-.079.037,18.02,18.02,0,0,0-5.49,0.005.07.07,0,0,0-.079-0.037A19.736,19.736,0,0,0,3.678,4.369a.07.07,0,0,0-.037.079A19.945,19.945,0,0,0,2.25,12.185a.08.08,0,0,0,.079.079,16.5,16.5,0,0,0,4.08,1.578.07.07,0,0,0,.079-0.037,12.7,12.7,0,0,0,1.815-2.2.07.07,0,0,0-.037-.107,10.63,10.63,0,0,1-1.3-1.02.07.07,0,0,1,.005-.121,11.85,11.85,0,0,0,2.1,1.528.07.07,0,0,0,.089-.027,13.6,13.6,0,0,0,1.88-2.115.07.07,0,0,0-.047-.117,10.51,10.51,0,0,1-1.27-1.01.07.07,0,0,1,.005-.121,11.83,11.83,0,0,0,2.1,1.528.07.07,0,0,0,.089-.027,13.84,13.84,0,0,0,1.88-2.115.07.07,0,0,0-.037-.107,10.6,10.6,0,0,1-1.3-1.02.07.07,0,0,1,.005-.121,11.9,11.9,0,0,0,2.1,1.528.07.07,0,0,0,.089-.027,12.7,12.7,0,0,0,1.815-2.2.07.07,0,0,0,.079,0.037,16.5,16.5,0,0,0,4.08-1.578.08.08,0,0,0,.079-0.079A19.945,19.945,0,0,0,20.317,4.369ZM8.02,15.33c-1.18,0-2.15-1.09-2.15-2.42s0.97-2.42,2.15-2.42,2.15,1.09,2.15,2.42S9.2,15.33,8.02,15.33Zm7.96,0c-1.18,0-2.15-1.09-2.15-2.42s0.97-2.42,2.15-2.42,2.15,1.09,2.15,2.42S17.16,15.33,15.98,15.33Z" />
    </svg>
);

export const InstagramIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.012 3.584-.07 4.85c-.148 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.07-1.645-.07-4.85s.012-3.584.07-4.85c.148-3.225 1.664-4.771 4.919-4.919C8.416 2.175 8.796 2.163 12 2.163m0-2.163C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12s.014 3.667.072 4.947c.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072s3.667-.014 4.947-.072c4.358-.2 6.78-2.618 6.98-6.98.059-1.281.073-1.689.073-4.948s-.014-3.667-.072-4.947c-.2-4.358-2.618-6.78-6.98-6.98C15.668.014 15.259 0 12 0zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.162 6.162 6.162 6.162-2.759 6.162-6.162-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4s1.791-4 4-4 4 1.79 4 4-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44 1.441-.645 1.441-1.44c0-.795-.645-1.44-1.441-1.44z"/>
    </svg>
);
...
export const WhatsappIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.39 1.27 4.85l-1.35 4.95 5.07-1.33c1.4.79 2.99 1.25 4.63 1.25h.01c5.46 0 9.91-4.45 9.91-9.91s-4.45-9.91-9.91-9.91zM12.04 20.15h-.01c-1.47 0-2.92-.38-4.21-1.11l-.3-.18-3.13.82.83-3.05-.2-.31c-.8-1.33-1.28-2.88-1.28-4.51 0-4.54 3.7-8.24 8.24-8.24 2.22 0 4.23.87 5.82 2.45s2.45 3.61 2.45 5.82c-.01 4.54-3.7 8.24-8.24 8.24zm4.52-6.14c-.25-.12-1.47-.73-1.7-.81-.22-.08-.38-.12-.54.12-.16.25-.64.81-.79.97-.15.16-.3.18-.54.06s-1.02-.38-1.94-1.2-1.44-1.39-1.61-1.63c-.17-.25-.02-.38.11-.5.11-.11.25-.28.37-.42s.16-.25.25-.42c.08-.16.04-.3-.02-.42s-.54-1.29-.74-1.77c-.2-.48-.4-.41-.54-.42-.14-.01-.3 0-.46 0s-.42.06-.64.3c-.22.25-.86.84-.86 2.05s.88 2.38 1 2.54c.12.16 1.73 2.65 4.2 3.72.6.26 1.07.41 1.44.53.51.16.97.14 1.32.08.39-.06 1.22-.5 1.4-1s.17-1.12.12-1.28c-.05-.16-.16-.25-.42-.37z"/>
    </svg>
);
