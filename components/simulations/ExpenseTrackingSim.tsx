...
const INITIAL_EXPENSES = [
    { name: 'Housing (Rent/Mortgage)', value: 1200, color: '#38BDF8' },
    { name: 'Transportation (Car, Gas, Public)', value: 300, color: '#34D399' },
    { name: 'Food (Groceries, Dining Out)', value: 400, color: '#F472B6' },
    { name: 'Utilities (Electric, Water, Internet)', value: 150, color: '#FBBF24' },
    { name: 'Subscriptions', value: 50, color: '#A78BFA' },
...
const ExpenseTrackingSim: React.FC<{ onComplete: () => void }> = ({ onComplete }) => {
    ...
    return (
        <Card className="max-w-5xl mx-auto p-6 md:p-8">
            <h2 className="text-3xl font-bold text-center mb-2 text-white">Expense Tracking</h2>
            <p className="text-brand-text-secondary text-center mb-8 max-w-3xl mx-auto">
                Understanding where your money goes is the first step toward financial freedom. Use this tool to input your typical monthly expenses (liabilities) to see a clear breakdown of your spending.
            </p>

            <div className="grid lg:grid-cols-2 gap-8">
                {/* Inputs */}
                <div className="bg-brand-bg/50 p-4 rounded-lg">
                    <h3 className="text-xl font-semibold text-white mb-4">Your Monthly Expenses</h3>
                ...
                <div className="flex flex-col gap-4">
                    <Card className="p-4 text-center bg-brand-surface">
                        <p className="text-sm text-brand-text-secondary">Total Monthly Liabilities</p>
